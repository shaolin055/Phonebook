...
void edit1();
/*------------------------------------------------------------------------------*/
char file[60]  = "F:\\storage.fat";
//char file_[60]  = "F:\\short.fat";
char file_1[60]  = "F:\\temp.fat";
char temp[60]	  = "F:\\tem.fat";
char up[60]    = "f:\\Phonebook\\upgrade.fat";
char file1[60]  ="F:\\information.fat";
...
void save()
{	int i;
	char a[20],c[20],*temp1,*temp2,*temp3;
	FILE *u;
...
{  int i,j,l=0,k=1,m=1,n=1;
	char name[20]="\0",phone[20]="\0",*temp1,*temp2,*temp3,*phone_,*name_,ch[20];
	FILE *u;
	temp1=(char*) malloc(200);
	temp2=(char*) malloc(200);
	temp3=(char*) malloc(200);
...
{  FILE *t;
	...
	for(i=0;i<max;i++)
	{strcpy(temp1,"\0");
	 fscanf(t,"%s %s %s ",temp1,temp2,temp3);
	 if(strlen(temp1)==0) break;
	 printf("%d) ",i+1);
	 encode1(temp1);
	 encode(temp1);
...
{  int i,j,k;
 //	int x;
	char name[20],ch[20],c[20],*temp1,*temp2,*temp3,*temp4,*temp5,*temp6;
	FILE *u,*v;
	temp1=(char*) malloc(200);
	temp2=(char*) malloc(200);
	temp3=(char*) malloc(200);
...
void fresh()
{	int i,j,l,k=1,x=0;
	char *name,*pho,*ad,*name_="\0",*pho_="\0",*ad_="\0";
	FILE *u,*v;
	v=fopen(file_1,"wb");
	fclose(v);
//	v=fopen(file_1,"ab");
