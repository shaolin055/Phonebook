...
void edit1();
/*------------------------------------------------------------------------------*/
char file[60]  = "F:\\Phonebook\\data\\phone.txt";
char up[60]    = "F:\\Phonebook\\upgrade.txt";
char file1[60]  ="F:\\Phonebook\\data\\personal.txt";
...
//	if((((int)x*10)%10)==0) printf("All computer suitable virsion.");
//	if((((int)x*10)%10)!=0) printf("Working virsion.");	
	getchar();
	getchar();
	clrscr();
	printf("To go to \"MAIN MENU\" press \"M\"\nTo exit press anykey.\n\n ->");
...
5) First almost all computer useable virsion (actually 1.01 virsion)
...
10) Next virsion will contain the safer data storage system with .dat or .fat etc.*/
