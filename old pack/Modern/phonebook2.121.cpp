...
void edit1();
/*------------------------------------------------------------------------------*/
char file[60]  = "f:\\sink.cat";
//char file_[60]  = "F:\\short.fat";
char file_1[60]  = "F:\\temp.cat";
char temp[60]	  = "F:\\tem.cat";
char up[60]    = "f:\\Phonebook\\upgrade.fat";
char file1[60]  ="F:\\information.cat";
char inf[60]	="F:\\setting.fat";
...
2.13) using handy ';' insdie of '*' for space operator.(direvtory: f:\\sink.cat)
*/
