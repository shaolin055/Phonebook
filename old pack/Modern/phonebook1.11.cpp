...
void edit1();
/*------------------------------------------------------------------------------*/
char file[60]  = "F:\\c\\Phonebook\\data\\phone.txt";
char up[60]    = "f:\\c\\upgrade.txt";
char file1[60]  ="F:\\c\\Phonebook\\data\\personal.txt";
...
/*
1)Personal information store facilities**
2)Floating update concious version.
3)Cradit informer virsion.
4)Some problem solving stakes included.
5)First almost all computer useable virsion (actually 0 virsion)
...
7)From now, other virsion's are dicleared as "old virsion" & it is strongly quoted that their update number & patern will not match with "new virsions" from now.
*/
